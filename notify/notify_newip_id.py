...
if __name__ == '__main__':
    ...
    parser.add_argument('-lbn', '--library_name', action='store', default='',
                        help='The name of the TV show')
    parser.add_argument('-mid', '--machine_id', action='store', default='',
                        help='The unique identifier for the player')
    parser.add_argument('-mtype', '--msg_type', action='store', default='',
                        help='send format')
    parser.add_argument('-ntype', '--NOTIFIER_ID', action='store', default='',
                        help='notifier id')
    ...
    if p.msg_type == "plain":
        ...
        BODY_TEXT = """\
            ...
            from a new IP address: {p.ip_address}
